    ...
    <Container className='user-dashboard-container'>
      <Row>
        <Col md={2} className='sidebar'>
          ...
          <Button
            variant='primary'
            className={`dashboard-button my-bookings-button ${
          ...
          {user && user.userType === "admin" && (
            <>
              ...
              <Button
                variant='primary'
                className={`dashboard-button add-facility-button ${
                  activeTab === "addfacility" ? "active" : ""
                }`}
              ...
              <Button
                variant='primary'
                className={`dashboard-button get-all-bookings-button ${
                  activeTab === "getallbookings" ? "active" : ""
                }`}
        ...
        <Col md={10} className='content'>
          ...
          <Row className='mt-4 justify-content-center'>
            <Col
              md={
                activeTab === "addroom" || activeTab === "addfacility" ? 6 : 12
              }
            >
              {renderContent()}
            </Col>
